...
// countries_data.reduce((obj, item, index) => {
//     // console.log(Object.keys(obj).indexOf(item.languages[index].name));
//     if (Object.keys(obj).indexOf(item.languages[index].name) == -1) {
//         obj[item.languages[index].name] = 1
//         console.log('new val');
//     } else {
//         obj[item.languages[index].name]++
//         console.log('old val');
//     }
// }, {
...
// let newArr = products.map(item => item.price).filter(num => num > 0).reduce((acc, val) => acc + val)

// console.log(newArr);ù
